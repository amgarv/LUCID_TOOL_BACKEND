...
def hello_world():
    ...
    if deployment_url:
        ...
        qualtrics_url = f"https://{deployment_url}/chatgolem" if not deployment_url.startswith("http") else f"{deployment_url}/chatgolem"
...
def chatgolem():
    ...
    print(f"INFO: ------ Entered chatgolem function with method: {request.method} from allowed origin: {origin} ------")
